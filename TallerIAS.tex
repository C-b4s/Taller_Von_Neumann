...
siguientes preguntas considerando la Tabla \ref{tab:org2319730} como el
mapa de memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL.

\begin{table}[htbp]
\caption{\label{tab:org2319730}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
