...
\addbibresource{/home/stevenech/bibliography/bibliography.bib}
...
siguientes preguntas considerando la Tabla \ref{tab:org7089dd5} como el
mapa de memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL.

\begin{table}[htbp]
\caption{\label{tab:org7089dd5}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
