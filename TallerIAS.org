...
#+email: sebastian.zuniga@epn.edu.eces
#+date: 2026-06-12
#+language: es
...
3. ¿Cuál es el valor del bit de Carry? ¿Qué operación modifica el bit?
   ...
   - Este único carry, se tiene durante la ejecución de la primera
...
| Nombre            | Email                       | Rol         |
|-------------------+-----------------------------+-------------|
| Sebastián Zúñiga  | sebastian.zuniga@epn.edu.ec | Líder       |
| Steven Echeverría |                             | Colaborador |
| Mateo Jami        | mateo.jami@epn.edu.ec       | Colaborador |
| Martín Pérez      | martin.perez@epn.edu.ec     | Colaborador |
|-------------------+-----------------------------+-------------|
